...
@{
    ...
    FunctionsToExport    = 'ConvertTo-Base64UrlEncodedString', 'ConvertFrom-Base64UrlEncodedString', 'New-JwtSignature', 'New-JsonWebToken', 'Test-JsonWebToken', 'ConvertFrom-EncodedJsonWebToken', 'New-JsonWebKeySet', 'New-JsonWebKey', 'Get-JsonWebTokenHeader', 'Get-JsonWebTokenPayload', 'Get-JsonWebTokenSignature', 'ConvertTo-JwtPart', 'Test-JwtStructure', 'Test-JwtSignature', 'Convert-DateTimeToEpoch', 'Convert-EpochToDateTime', 'Test-JwtDateRange', 'Convert-X509CertificateToBase64', 'Get-JwkCollection', 'Show-DecodedJwt'

    # Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
    AliasesToExport      = 'jwtd', 'djwt', 'njwt', 'NewJwt', 'CreateJwt', 'tjwt', 'sjwt', 'ValidateJwt', 'DecodeJwt', 'njwks', 'CreateJwkSet', 'njwk', 'CreateJwk', 'b64e', 'Encode', 'b64d', 'Decode', 'GetEpoch', 'gjwth', 'gjwtp', 'gjwtsig', 'gjwkc'
